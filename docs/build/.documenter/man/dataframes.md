...
# DataFrame &amp; GroupedDataFrame Integration {#DataFrame-and-GroupedDataFrame-Integration}
...
## 1. Type Safety and Column Validation {#1.-Type-Safety-and-Column-Validation}
...
## 2. DataFrame Integration {#2.-DataFrame-Integration}

### Standard Hypothesis Tests {#Standard-Hypothesis-Tests}
...
### Contingency Table Tests {#Contingency-Table-Tests}
...
## 3. GroupedDataFrame Integration {#3.-GroupedDataFrame-Integration}
...
### Numerical &amp; Distributional Tests {#Numerical-and-Distributional-Tests}
...
### Categorical Tests (Rows from Groups) {#Categorical-Tests-Rows-from-Groups}
...
## 4. Trend and Association Tests {#4.-Trend-and-Association-Tests}
...
### Linear-by-Linear Association {#Linear-by-Linear-Association}
...
## 5. Post-Hoc Analysis {#5.-Post-Hoc-Analysis}
...
### Contingency Table Post-Hoc {#Contingency-Table-Post-Hoc}
